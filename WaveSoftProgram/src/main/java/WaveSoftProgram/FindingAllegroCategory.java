...
public class FindingAllegroCategory {
    ...
    public static void jsonFileReader() throws IOException {
        ...
        FileReader file = new FileReader("AllegroCategories.json");
    ...
    public static void jsonHandler() throws JSONException, IOException {
        ...
        String programInstruction = "Znajdź część której szukasz na Allegro.";
        ...
        for (int i = 0; i < arrJSON.length(); i++) {
            ...
            if (in.equalsIgnoreCase(obj1.getString("czesc"))) {
                ...
                System.out.println("-----------------------------------\n");
                System.out.println(" ");
                System.out.println("Kategoria: " + categoryPart + "\nLink do kategorii na Allegro: " +
                        link);
                System.out.println(" ");
                System.out.println(" ");
                System.out.println("-----------------------------------\n");

                FindingAllegroCategory idOfCar = new FindingAllegroCategory();
                idOfCar.jsonHandler();
                break;
